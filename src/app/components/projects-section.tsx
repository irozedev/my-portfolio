              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    ...
                    } rounded-3xl overflow-hidden border-2 border-white/10 hover:border-[#00d9ff]/50 transition-all duration-300 cursor-pointer active:scale-[0.98]`}
                  >
                    {/* Mobile TAP Indicator - Always visible on touch devices */}
                    <div className="md:hidden absolute top-4 right-4 z-20 flex items-center gap-2 px-4 py-2.5 bg-[#00d9ff] text-black rounded-full shadow-lg font-bold text-sm animate-pulse">
                      <Eye className="w-5 h-5" />
                      <span>TAP TO VIEW</span>
                    </div>

                    {/* Desktop Click Indicator - Only on hover */}
                    <div className="hidden md:flex absolute top-4 right-4 z-20 items-center gap-2 px-4 py-2.5 bg-[#00d9ff] text-black rounded-full shadow-lg font-bold text-sm opacity-0 group-hover:opacity-100 transition-opacity">
                      <Eye className="w-5 h-5" />
