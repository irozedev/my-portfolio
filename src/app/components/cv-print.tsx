    ...
    <div className="cv-root">
      ...
      <main className="cv-sheet" dir="auto">
        ...
        <section>
          ...
          <p className="cv-desc">
            {L(
              "Front-End / JavaScript developer with 8+ years of commercial experience, most of it in high-traffic e-commerce and enterprise systems: childrensalon.com and vogacloset.com in luxury retail, and CRM for a national bank, Ukraine's state savings bank. Comfortable owning a feature end to end — from the product question to the deployed page. Now based in Belgium and looking for a front-end role in Flanders or remote.",
              "Front-end/JavaScript-ontwikkelaar met 8+ jaar commerciële ervaring, grotendeels in e-commerce met veel verkeer en enterprisesystemen: childrensalon.com en vogacloset.com in luxe retail, en CRM voor een nationale bank, de Oekraïense staatsspaarbank. Neemt een feature van begin tot eind in eigen hand. Woont nu in België en zoekt een front-endfunctie in Vlaanderen of op afstand.",
              "مطوّر Front-End/JavaScript بخبرة تجارية تتجاوز 8 سنوات، معظمها في متاجر إلكترونية عالية الزيارات وأنظمة مؤسسية: childrensalon.com وvogacloset.com في التجزئة الفاخرة، ونظام CRM لأحد البنوك الوطنية الحكومي الأوكراني. أتولى الميزة من الفكرة حتى النشر. أقيم الآن في بلجيكا وأبحث عن وظيفة front-end في فلاندرز أو عن بُعد.",
              "Desarrollador Front-End/JavaScript con más de 8 años de experiencia comercial, sobre todo en e-commerce de alto tráfico y sistemas empresariales: childrensalon.com y vogacloset.com en retail de lujo, y CRM para un banco nacional, la caja de ahorros estatal de Ucrania. Me hago cargo de una funcionalidad de principio a fin. Resido en Bélgica y busco un puesto de front-end en Flandes o en remoto.",
            )}
          </p>
        </section>
