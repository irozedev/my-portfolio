          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            >
              ...
              <motion.div
                ...
                className="bg-gradient-to-br from-[var(--bg-secondary)] to-[var(--bg-tertiary)] backdrop-blur-sm border border-[var(--border-color)] rounded-xl sm:rounded-2xl p-4 sm:p-6 hover:border-[#00d9ff]/50 transition-all duration-300 group relative overflow-hidden"
              >
                {/* Glow Effect */}
                <div className="absolute inset-0 bg-gradient-to-r from-[#00d9ff]/5 to-purple-500/5 opacity-0 group-hover:opacity-100 transition-opacity" />
                
                <div className="relative z-10">
                  <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="p-2 sm:p-3 bg-gradient-to-br from-[#00d9ff]/20 to-purple-500/20 rounded-lg sm:rounded-xl">
                      <Zap className="w-5 h-5 sm:w-6 sm:h-6 text-[#00d9ff]" />
                    </div>
