...
const translations = {
  en: {
    ...
    reschedule: "Need to reschedule? Email hello@roze.live",
    morning: "Morning",
    afternoon: "Afternoon",
    free: "30 min • Free",
  },
  nl: {
    ...
    name: "Uw Naam",
    email: "Uw Email",
    purpose: "Waar gaat je project over?",
    purposePlaceholder: "Korte beschrijving van je project...",
    back: "Terug",
    confirm: "Bevestigen",
    booking: "Bezig met boeken...",
    confirmed: "Aanvraag verzonden!",
    confirmMsg: "Stepan bevestigt je gesprek per e-mail op",
    reschedule: "Verplaatsen? Mail hello@roze.live",
    morning: "Ochtend",
    afternoon: "Middag",
    free: "30 min • Gratis",
  },
  ar: {
    ...
    reschedule: "تحتاج إعادة جدولة؟ hello@roze.live",
    morning: "صباحاً",
    afternoon: "بعد الظهر",
  ...
  es: {
    ...
    reschedule: "¿Necesitas reprogramar? hello@roze.live",
    morning: "Mañana",
    afternoon: "Tarde",
    free: "30 min • Gratis",
  },
