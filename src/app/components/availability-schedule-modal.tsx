...
export function AvailabilityScheduleModal({ isOpen, onClose, onBookCall }: AvailabilityScheduleModalProps) {
  ...
  const translations = {
    ...
    days: {
      Monday: { en: "Monday", nl: "Maandag", ar: "الاثنين", es: "Lunes" },
      Tuesday: { en: "Tuesday", nl: "Dinsdag", ar: "الثلاثاء", es: "Martes" },
      Wednesday: { en: "Wednesday", nl: "Woensdag", ar: "الأربعاء", es: "Miércoles" },
      Thursday: { en: "Thursday", nl: "Donderdag", ar: "الخميس", es: "Jueves" },
      Friday: { en: "Friday", nl: "Vrijdag", ar: "الجمعة", es: "Viernes" },
      Saturday: { en: "Saturday", nl: "Zaterdag", ar: "السبت", es: "Sábado" },
      Sunday: { en: "Sunday", nl: "Zondag", ar: "الأحد", es: "Domingo" },
    },
    available: {
      en: "Available",
      nl: "Beschikbaar",
