...
const experiences = [
  {
    ...
    location: "Remote, EU",
    type: "Full-time",
    description: "Leading full-stack development projects for European clients, specializing in React, Next.js, and Node.js ecosystems",
    achievements: [
      "Built 20+ production-ready applications",
      "Managed projects worth €500K+ total value",
  ...
  },
  {
    ...
    type: "Full-time",
    description: "Led frontend architecture for B2B e-commerce platform serving 10K+ businesses",
    achievements: [
      "Rebuilt platform with React + TypeScript",
      "Improved performance by 75%",
      "Mentored team of 5 junior developers",
      "Implemented design system used company-wide"
    ],
    tech: ["React", "TypeScript", "Redux", "GraphQL", "Styled Components", "Jest"],
    icon: Code2,
  ...
  },
  {
    ...
    location: "Remote",
    type: "Full-time",
    description: "Modernized legacy systems and built Vue.js applications for diverse client base",
    achievements: [
      "Migrated 10+ jQuery apps to Vue.js",
      "Reduced bundle size by 50%",
      "Implemented automated testing pipeline",
      "Created reusable component library"
    ],
    tech: ["Vue.js", "JavaScript", "SASS", "Webpack", "REST APIs", "Git"],
    icon: Users,
  ...
  },
  {
    ...
    location: "Ukraine",
    type: "Freelance",
    description: "Built custom WordPress solutions and JavaScript applications for 40+ clients",
    achievements: [
      "Delivered 40+ successful projects",
      "Maintained 99% client satisfaction",
      "Ranked websites in top 3 for SEO",
      "Built e-commerce stores with WooCommerce"
    ],
    tech: ["WordPress", "PHP", "JavaScript", "jQuery", "MySQL", "SEO"],
    icon: Building2,
