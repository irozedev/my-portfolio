export const translations = {
  en: {
    ...
    services: {
      ...
      timeline: 'Timeline',
      perHour: '/hour',
      priceNote: 'Starting price · VAT may apply',
      popular: 'POPULAR',
  ...
  uk: {
    ...
    services: {
      ...
      timeline: 'Терміни',
      perHour: '/годину',
      priceNote: 'Стартова ціна · ПДВ за потреби',
      popular: 'ПОПУЛЯРНЕ',
  ...
  nl: {
    ...
    services: {
      ...
      timeline: 'Tijdlijn',
      perHour: '/uur',
      priceNote: 'Vanafprijs · btw indien van toepassing',
      popular: 'POPULAIR',
  ...
  ar: {
    ...
    services: {
      ...
      perHour: '/الساعة',
      priceNote: 'سعر مبدئي · قد تُضاف الضريبة',
  ...
  es: {
    ...
    services: {
      ...
      timeline: 'Plazo',
      perHour: '/hora',
      priceNote: 'Precio inicial · IVA si aplica',
      popular: 'POPULAR',
