export const translations = {
  en: {
    ...
    about: {
      ...
      description: 'From large-scale luxury retail platforms (childrensalon.com, vogacloset.com) to banking systems (a national bank), I build fast, maintainable interfaces with JavaScript, TypeScript, React, Vue and Next.js — and I\'ve shipped a commercial Next.js 14 product end-to-end.',
  ...
  ar: {
    ...
    about: {
      ...
      description: 'من منصات البيع بالتجزئة الفاخرة واسعة النطاق (childrensalon.com، vogacloset.com) إلى الأنظمة المصرفية (أحد البنوك الوطنية)، أبني واجهات سريعة وقابلة للصيانة باستخدام JavaScript وTypeScript وReact وVue وNext.js — وأطلقت منتج Next.js 14 تجارياً من البداية إلى النهاية.',
  ...
  es: {
    ...
    about: {
      ...
      description: 'Desde plataformas de retail de lujo a gran escala (childrensalon.com, vogacloset.com) hasta sistemas bancarios (un banco nacional), construyo interfaces rápidas y mantenibles con JavaScript, TypeScript, React, Vue y Next.js — y he lanzado un producto comercial en Next.js 14 de principio a fin.',
