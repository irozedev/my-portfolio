export const translations = {
  en: {
    ...
    hero: {
      ...
      role: 'I build high-converting websites & AI automation for businesses',
      aiEnthusiast: 'AI Enthusiast',
      description: 'I help startups and businesses launch fast, modern websites and automate processes using AI. Focused on performance, UX and real results.',
    ...
    services: {
      ...
      timeline: 'Timeline',
      perHour: '/hour',
      priceNote: 'Starting price · no VAT (small-business scheme)',
      popular: 'POPULAR',
  ...
  uk: {
    ...
    hero: {
      ...
      role: 'Створюю конверсійні сайти та AI автоматизацію для бізнесу',
      aiEnthusiast: 'AI Ентузіаст',
      description: 'Допомагаю стартапам та бізнесу запускати швидкі, сучасні сайти та автоматизувати процеси за допомогою AI. Фокус на продуктивності, UX та реальних результатах.',
      bookCall: 'Почати проект',
      viewWork: 'Переглянути роботи',
      viewServices: 'Послуги',
    ...
    services: {
      ...
      timeline: 'Терміни',
      perHour: '/годину',
      priceNote: 'Стартова ціна · без ПДВ (спецрежим для малого бізнесу)',
      popular: 'ПОПУЛЯРНЕ',
  ...
  ar: {
    ...
    hero: {
      ...
      role: 'أنشئ مواقع عالية التحويل وأتمتة الذكاء الاصطناعي للشركات',
      aiEnthusiast: 'عاشق الذكاء الاصطناعي',
      description: 'أساعد الشركات الناشئة والشركات على إطلاق مواقع سريعة وحديثة وأتمتة العمليات باستخدام الذكاء الاصطناعي. التركيز على الأداء وتجربة المستخدم والنتائج الحقيقية.',
      bookCall: 'ابدأ المشروع',
    ...
    services: {
      ...
      perHour: '/الساعة',
      priceNote: 'سعر مبدئي · بدون ضريبة القيمة المضافة (نظام المنشآت الصغيرة)',
  ...
  es: {
    ...
    hero: {
      ...
      role: 'Creo sitios web de alta conversión y automatización de IA para empresas',
      aiEnthusiast: 'Entusiasta de IA',
      description: 'Ayudo a startups y empresas a lanzar sitios web rápidos y modernos y automatizar procesos usando IA. Enfocado en rendimiento, UX y resultados reales.',
      bookCall: 'Iniciar proyecto',
    ...
    services: {
      ...
      timeline: 'Plazo',
      perHour: '/hora',
      priceNote: 'Precio inicial · sin IVA (régimen de pequeñas empresas)',
      popular: 'POPULAR',
